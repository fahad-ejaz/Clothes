                    ...
                    <div className="footer__contact__container">
                        ...
                        <ul className="footer__contacts">
                            <li className="footer__contact">
                                <span className="footer__contact__icons"><LocalPhoneIcon /></span>
                                <span>+123 4567 890</span>
                            </li>
                            <li className="footer__contact">
                                <span className="footer__contact__icons"><EmailIcon /></span>
                                <span>shop@clothes.com</span>
                            </li>
                            <li className="footer__contact">
                                <span className="footer__contact__icons"><LocationOnIcon /></span>

...
export default function Fancy() {
  return (
    <Canvas eventSource={document.getElementById('fancy')} eventPrefix="client" camera={{ position: [0, 0, 4], fov: 40 }}>
...
function Shoe(props) {
  const ref = useRef();
  const { nodes, materials } = useGLTF('../../../public/nike_air_zoom_pegasus_36-transformed.glb');
  useFrame((state) => {
...
useGLTF.preload('../../../public/nike_air_zoom_pegasus_36-transformed.glb');
